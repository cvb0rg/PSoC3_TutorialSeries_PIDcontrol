...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=5, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=true, InterruptOnTC=false, Period=10, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=8, RunMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=true, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=hallTickCounter, CY_INSTANCE_SHORT_NAME=hallTickCounter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=hallTickCounter, )
...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, DeviceFamily=PSoC3, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=4294967295, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=32, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=3, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Timer_v2_70, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=hallTickTimer, CY_INSTANCE_SHORT_NAME=hallTickTimer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=hallTickTimer, )
...
module top ;
	...
	wire [0:0] tmpOE__hallEffectSensor_net;
	wire [0:0] tmpIO_0__hallEffectSensor_net;
	wire [0:0] tmpINTERRUPT_0__hallEffectSensor_net;
	electrical [0:0] tmpSIOVREF__hallEffectSensor_net;
	...
	cy_psoc3_pins_v1_10
		...
		hallEffectSensor
		 (.oe(tmpOE__hallEffectSensor_net),
		  .y({1'b0}),
		  .fb({Net_16}),
		  .io({tmpIO_0__hallEffectSensor_net[0:0]}),
		  .siovref(tmpSIOVREF__hallEffectSensor_net),
		  .interrupt({tmpINTERRUPT_0__hallEffectSensor_net[0:0]}),
		  .annotation({Net_15}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__hallEffectSensor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 driveMotorDC (
        .connect({
            Net_19,
            Net_20
        })
    );
    defparam driveMotorDC.comp_name = "Motor_v1_0";
    defparam driveMotorDC.port_names = "T1, T2";
    defparam driveMotorDC.width = 2;

    cy_annotation_universal_v1_0 motorDriverMOSFET (
        .connect({
            Net_25,
            Net_886,
            Net_19
    ...
    defparam motorDriverMOSFET.comp_name = "NFET_En_v1_0";
    defparam motorDriverMOSFET.port_names = "D, G, S";
    defparam motorDriverMOSFET.width = 3;

    cy_annotation_universal_v1_0 Battery_Motor (
        .connect({
            Net_79,
            Net_25
        })
    );
    defparam Battery_Motor.comp_name = "Battery_v1_0";
    defparam Battery_Motor.port_names = "Neg, Pos";
    defparam Battery_Motor.width = 2;

    Counter_v3_0_1 hallTickCounter (
        .reset(Net_506),
        .tc(Net_558),
        .comp(Net_559),
        .clock(Net_535),
        ...
        .up_ndown(1'b1),
        .count(Net_566));
    defparam hallTickCounter.CaptureMode = 0;
    defparam hallTickCounter.ClockMode = 0;
    defparam hallTickCounter.CompareMode = 1;
    defparam hallTickCounter.CompareStatusEdgeSense = 1;
    defparam hallTickCounter.EnableMode = 0;
    defparam hallTickCounter.ReloadOnCapture = 0;
    defparam hallTickCounter.ReloadOnCompare = 0;
    defparam hallTickCounter.ReloadOnOverUnder = 1;
    defparam hallTickCounter.ReloadOnReset = 1;
    defparam hallTickCounter.Resolution = 8;
    defparam hallTickCounter.RunMode = 0;
    defparam hallTickCounter.UseInterrupt = 1;

    cy_annotation_universal_v1_0 LM7805_Regulator (
        .connect({
            Net_78,
            Net_49,
            Net_66
    ...
    defparam LM7805_Regulator.comp_name = "VREG_v1_0";
    defparam LM7805_Regulator.port_names = "REF, VIN, VOUT";
    defparam LM7805_Regulator.width = 3;

    cy_annotation_universal_v1_0 Battery_PSoC (
        .connect({
            Net_53,
            Net_49
        })
    );
    defparam Battery_PSoC.comp_name = "Battery_v1_0";
    defparam Battery_PSoC.port_names = "Neg, Pos";
    defparam Battery_PSoC.width = 2;

    cy_annotation_universal_v1_0 hallEffectSensorAbstraction (
        .connect({
            Net_78,
            Net_15,
            Net_66,
    ...
    defparam hallEffectSensorAbstraction.comp_name = "ExtOpAmp_v1_0";
    defparam hallEffectSensorAbstraction.port_names = "N, O, P, VN, VP";
    defparam hallEffectSensorAbstraction.width = 5;


    assign Net_548 = ~Net_16;
    ...
    Timer_v2_70_2 hallTickTimer (
        ...
        .tc(Net_545),
        .clock(Net_535));
    defparam hallTickTimer.CaptureCount = 2;
    defparam hallTickTimer.CaptureCounterEnabled = 0;
    defparam hallTickTimer.DeviceFamily = "PSoC3";
    defparam hallTickTimer.InterruptOnCapture = 0;
    defparam hallTickTimer.InterruptOnTC = 0;
    defparam hallTickTimer.Resolution = 32;
    defparam hallTickTimer.SiliconRevision = "3";
    ...
    assign Net_567 = Net_415 | Net_548;


	cy_clock_v1_0
		#(.id("d39a31b2-1b96-4090-8608-7637205b3c4a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__SyncOut_net;
	wire [0:0] tmpFB_0__SyncOut_net;
	wire [0:0] tmpIO_0__SyncOut_net;
	wire [0:0] tmpINTERRUPT_0__SyncOut_net;
	electrical [0:0] tmpSIOVREF__SyncOut_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("99cb0731-0f96-4f9a-aa28-151af64881b1"),
		  ...
		  .input_buffer_sel(2'b00))
		SyncOut
		 (.oe(tmpOE__SyncOut_net),
		  .y({Net_172}),
		  .fb({tmpFB_0__SyncOut_net[0:0]}),
		  .io({tmpIO_0__SyncOut_net[0:0]}),
		  .siovref(tmpSIOVREF__SyncOut_net),
		  .interrupt({tmpINTERRUPT_0__SyncOut_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SyncOut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_3 PWM_GateVoltage (
        ...
        .ph1(Net_881),
        .ph2(Net_882));
    defparam PWM_GateVoltage.Resolution = 8;


	cy_clock_v1_0
		#(.id("2acb65f2-dfe3-47c2-b7c6-0c8e1d27fd6f"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__MOSFET_Gate_net;
	wire [0:0] tmpFB_0__MOSFET_Gate_net;
	wire [0:0] tmpIO_0__MOSFET_Gate_net;
	wire [0:0] tmpINTERRUPT_0__MOSFET_Gate_net;
	electrical [0:0] tmpSIOVREF__MOSFET_Gate_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("014aa248-0679-4561-88db-711f379218f2"),
		  ...
		  .input_buffer_sel(2'b00))
		MOSFET_Gate
		 (.oe(tmpOE__MOSFET_Gate_net),
		  .y({Net_820}),
		  .fb({tmpFB_0__MOSFET_Gate_net[0:0]}),
		  .io({tmpIO_0__MOSFET_Gate_net[0:0]}),
		  .siovref(tmpSIOVREF__MOSFET_Gate_net),
		  .interrupt({tmpINTERRUPT_0__MOSFET_Gate_net[0:0]}),
		  .annotation({Net_887}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__MOSFET_Gate_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
