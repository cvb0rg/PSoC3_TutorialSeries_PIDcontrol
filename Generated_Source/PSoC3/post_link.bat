...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "E:\Win10\PSoC Creator\302_CarLab\SpeedControl.cydsn\SpeedControl.svd" rem "E:\Win10\PSoC Creator\302_CarLab\SpeedControl.cydsn\SpeedControl.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
